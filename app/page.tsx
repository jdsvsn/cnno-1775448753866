...
const basePath = '/cnno-1775448753866';
...
export default function Home() {
  ...
  const products = [{ n: 'OG Rolls', d: 'Our signature cinnamon rolls, carefully crafted with the finest ingredients and a hint of sweetness, perfect for satisfying your cravings. Made fresh daily to ensure the highest quality and flavor.', i: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1200&q=80', icon: 'domain' }, { n: 'Pistachio Rolls', d: 'A unique twist on our classic rolls, infused with the nutty flavor of pistachios and a touch of elegance. Perfect for those seeking a delicious adventure.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80', icon: 'architecture' }, { n: 'Chocolate Rolls', d: 'Indulge in the richness of our chocolate rolls, made with high-quality cocoa and a dash of love. A decadent treat for anyone with a sweet tooth.', i: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80', icon: 'chair' }, { n: 'Baby Rolls', d: 'Bite-sized versions of our beloved rolls, perfect for snacking on-the-go or sharing with friends and family. Soft, fluffy, and full of flavor.', i: 'https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=1200&q=80', icon: 'eco' }, { n: 'Party Box', d: 'A selection of our finest rolls, carefully packaged for special occasions or gatherings. Ideal for parties, events, or simply sharing the joy of sweet treats with loved ones.', i: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80" alt="Hero" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft and deliver artisanal sweet rolls that bring comfort, warmth, and indulgence to our community, while consistently exceeding customer expectations through quality, creativity, and exceptional service.</p>
                </div>
                <div className="space-y-2">
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1200&q=80" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=1200&q=80" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
